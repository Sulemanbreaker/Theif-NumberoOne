...
\033[1;94m ┈┈┈▕▕. ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mSulemanBreaker.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93mSulemanBreaker\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Suleman_Breaker

\033[1;92m☞ WhatsApp   : 03021474365

\033[1;95m☞ Facebook    : https://www.facebook.com/ClonerClaimer.09890
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.facebook.com/ClonerClaimer.09890')
		    ...
		    if "www.facebook.com" in z["error_msg"]:
		        ...
		        print (R + 'Account is going CheckPoint!')
...
def menu():
	...
	try:
		...
		print (G + 'Account is going CheckPoint!')
	...
	print (S + '[' + P + '☞1' + S + ']' + S + ' Alhumdulillah')

	print (S + '[' + P + '☞2' + S + ']' + S + ' Suleman_Breaker')

	print (S + '[' + P + '☞3' + S + ']' + S + ' Breaking is my Faction')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('Facebook https://www.facebook.com/ClonerClaimer.09890✓')

	    psb('WellCome To Suleman_Breaker')

	    psb('Congratulations Suleman_Breaker Tool Has Been Updated Successfully')
...
def pak():
	...
	print (S + '[' + P + '☞1' + S + ']' + P + ' Friend List Cloning')

	print (S + '[' + P + '☞2' + S + ']' + P + ' Public Account Cloning')

	print (S + '[' + Y + '☞3' + S + ']' + Y + ' From File Cloning')

	print (S + '[' + R + '☞0' + S + ']' + R + ' Get Back')
...
def pb():
	...
	print(S+'Alhumdulillah Cloning is finished CP ID Open After 9 Days Thanks JazakAllah')

	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(oks))+S+'/'+R+str(len(cps)))

	print(S+'Suleman_Breaker')     
